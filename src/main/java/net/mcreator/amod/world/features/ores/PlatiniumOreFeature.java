...
public class PlatiniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("a_mod:platinium_ore", FEATURE,
				new OreConfiguration(PlatiniumOreFeatureRuleTest.INSTANCE, AModModBlocks.PLATINIUM_ORE.get().defaultBlockState(), 0));
		PLACED_FEATURE = PlacementUtils.register("a_mod:platinium_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(1), InSquarePlacement.spread(),
				HeightRangePlacement.triangle(VerticalAnchor.absolute(1), VerticalAnchor.absolute(7)), BiomeFilter.biome()));
		return FEATURE;
	}
