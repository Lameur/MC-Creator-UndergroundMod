...
public class GlobalBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final GlobalBiomeLeaveDecorator INSTANCE = new GlobalBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("global_biome_tree_leave_decorator");
