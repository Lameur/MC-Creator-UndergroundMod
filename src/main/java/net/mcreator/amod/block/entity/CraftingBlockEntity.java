package net.mcreator.amod.block.entity;
...
public class CraftingBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CraftingBlockEntity(BlockPos position, BlockState state) {
		super(AModModBlockEntities.CRAFTING.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CraftingGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final FluidTank fluidTank = new FluidTank(100000, fs -> {
